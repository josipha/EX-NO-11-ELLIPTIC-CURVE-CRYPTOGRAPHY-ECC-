...
int main() {
    ...
    printf("Enter Josipha's private key: ");
    scanf("%lld", &privateA);
    printf("Enter John's private key: ");
    scanf("%lld", &privateB);
    ...
    printf("Josipha's public key: (%lld, %lld)\n", publicA.x, publicA.y);
    printf("John's public key: (%lld, %lld)\n", publicB.x, publicB.y);
    ...
    printf("Shared secret computed by Josipha: (%lld, %lld)\n", sharedSecretA.x, sharedSecretA.y);
    printf("Shared secret computed by John: (%lld, %lld)\n", sharedSecretB.x, sharedSecretB.y);
...
## Output:
<img width="1698" height="912" alt="image" src="https://github.com/user-attachments/assets/01e3f21e-5520-4935-8a5b-f727e266e7e7" />
